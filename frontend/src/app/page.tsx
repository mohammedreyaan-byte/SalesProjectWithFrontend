      ...
      <DashboardLayout>
        <div className="space-y-6">
          <div>
            ...
            <p className="text-muted-foreground mt-1">All products from CSV — add, edit, delete.</p>
          </div>
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Products</h1>
            <p className="text-muted-foreground mt-1">All products loaded from CSV — every row is displayed. Use search, pagination, Add, Edit, Delete.</p>
          </div>
